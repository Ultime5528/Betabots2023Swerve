...
class SwerveModule:
    def __init__(self, drive_motor_port, turning_motor_port, drive_encoder_channel_a, drive_encoder_channel_b,
        ...
        self.m_drive_encoder.setPositionConversionFactor(2 * math.pi * k_wheel_radius / k_encoder_resolution)
        self.m_turning_encoder.setPositionConversionFactor(2 * math.pi / k_encoder_resolution)
    ...
    def get_state(self):
        return SwerveModuleState(self.m_drive_encoder.getVelocity(), Rotation2d(self.m_turning_encoder.getPosition()))

    def get_position(self):
        return SwerveModulePosition(self.m_drive_encoder.getPosition(), Rotation2d(self.m_turning_encoder.getPosition()))
